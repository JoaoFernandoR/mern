### The goal is to build a full stack project using the MERN stack (MongoDB, Express, React and NodeJS), where users can share places ( with images and locations ) with other users;
